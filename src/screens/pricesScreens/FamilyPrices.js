...
const FamilyPrices = () => {
  ...
  const familyRef = ref(
    storage,
    "gs://tinkerbellphotograpy.appspot.com/Gallery/Family/Prices/"
  );

  useEffect(() => {
    try {
      listAll(familyRef).then((response) => {
  ...
  return (
    <Container style={{ marginTop: "10%" }} fluid>
      {loading ? (
        ...
        <Container>
          <Container>
            <h1 className="text-center">צילומי משפחה</h1>
          </Container>
          <Container>
                    ...
                    {image.name === "1" ? (
                      ...
                      <Col>
                        ...
                        >
                          <Card.Img variant="top" src={image.url} />
                          <Card.Body className="text-center">
                            <Card.Title>חבילה קטנה</Card.Title>
                            <Card.Text>400 ש"ח</Card.Text>
                          </Card.Body>
                          <Card.Footer>
                            <ul dir="rtl" className="text-muted">
                              <li>עד חצי שעה צילומים</li>
                              <li>ללא הגבלת אביזרים ורקעים</li>
                              <li>5 תמונות ערוכות בפטושופ</li>
                              <li>כל התמונות מיום הצילומים בערכיה בסיסית</li>
                              <li>
                                צילומי שמפחה ללא הגבלת ילדים (תוספת של 50ש"ח)
                              </li>
