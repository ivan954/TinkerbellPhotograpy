...
const NewBornPrices = () => {
	return (
		<Container style={{ marginTop: '10%' }} fluid>
			<Container>
				<h1 className='text-center'>מחירון צילומי ניובורן</h1>
				<p className='text-center'>
					צילומי ניוברון רצוי לצלם מ-5 ימים עד גיל 14 ימים, אבל אם לא הספקתם
					עדיין לא מאוחר וניתן להביא את הנסיך/ה שזה עתה נולדו לצילומי תינוקות.
					הצילומים מתבצעים אצלי בסטודיו עם תאורה וטמפרטורה מתאימה ומובן עם המון
					סבלנות. אין צורך להביא אביזרים, הכל כבר נמצא בסטודיו. תוספות שיכולות
					להוסיף ולהפוך את החביה יותר מעניינת: מומלץ להביא צילום אולטרסאונד אם
					ויש או בובה ראשונה.
				</p>
			</Container>
			<Container>
