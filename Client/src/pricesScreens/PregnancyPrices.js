...
const PregnancyPrices = () => {
	return (
		<Container style={{ marginTop: '10%' }} fluid>
			<Container>
				<h1 className='text-center'>מחירון צילומי הריון</h1>
				<p className='text-center'>
					צילומי הריון הן חלק מהרגעים הכי אהובים עלי, כל התהליך לא מובן מאליו,
					מרגע הכניסה להיריון, מהלכו ועד הלידה. לצילומי הריון ממולץ להגעה בין
					השבועות 28-34. לצילומי היריון את מגיע מתי שבאמת נוח לך, ברוגע שלך
					ובאווירה קסומה מתעדים את הרגעי הקרבה והביחד שלך עם תינוקח רגע ליפני
					שהוא יוצא לעולם.
				</p>
			</Container>
			<Container>
