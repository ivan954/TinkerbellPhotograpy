...
const OneYearPrices = () => {
	return (
		<Container style={{ marginTop: '10%' }} fluid>
			<Container>
				<h1 className='text-center'>מחירון צילומי גיל שנה</h1>
				<p>
					...
					וקוסומים שאותם אתם תוכלו למצוא אצלי בטינרגבל סטודיו. אתם בטח יכולים
					לדמיין לעצמכים מה יקרה אם נושיב ילד בן שנה ועוגה יחד, אז אצלי בסטודיו
					הכל עובד הפוך, מה שבבית לרוב אסור אצלי בסטודיו מותר, ללכלך ולהיתלכלך
					זה המאות תוך כדי הנעה גדולה של הילד לאכול מתוק והרבה. אני עובדת בשיתוף
					פעולה עם מעצבת עוגות מיקצועית, אשר תכין את העוגה בהתאמה אישית עם המון
					תשוקה וטעם.
				</p>
			</Container>
			<Container>
